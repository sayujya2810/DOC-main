...
const Mint = (props) => {
  ...
  return (
    // <div id='mint-section' style={{zIndex:19, padding:"0px",margin:"0px"}}  onLoad={logout}>
      <Popup arrow={false} style={{backgroundColor:"black", display:"relative", justifyContent:"flex-start"}} trigger={<button id="addressBtn" style={{ borderRadius: "5px", backgroundColor:"white" ,color:"black", padding:".1rem", marginRight:"1rem", marginTop:"1rem", position:"relative", width: "8rem"}}>Connect Wallet</button>} >
