...
const Footer = () => {
  return (
    ...
    <div id='social' style={{cursor:"none",color:"white", backgroundColor:"black", display:"flex", flexDirection:"column",height: "30vh", alignItems:"center", justifyContent:"center", padding:"1rem", fontSize:"15px"}}>
